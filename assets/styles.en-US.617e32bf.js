import{d as a,c as n,b as l,o as e}from"./vue.724a6942.js";const t={class:"markdown-body"},p=l(`<h2>Styles</h2><h3>Independent CSS File</h3><p><code class="">Quarkc</code> supports using independent <code class="">CSS</code> file to development, you only need to pass the <code class="">CSS</code> file\u2019s content as <code class="">style</code> property\u2019s value to <code class="">@customElement</code>.</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement, property } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
