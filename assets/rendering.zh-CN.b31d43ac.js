import{d as a,c as n,b as l,o as p}from"./vue.5602f49f.js";const t={class:"markdown-body"},e=l(`<h2>\u6E32\u67D3</h2><p>\u4E3A\u4F60\u7684\u81EA\u5B9A\u4E49\u5143\u7D20\u6DFB\u52A0\u4E00\u4E2A <code class="">render</code> \u65B9\u6CD5\u3002</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
</code></pre>`,10),c=[e],j={},m="",d=a({__name:"rendering.zh-CN",setup(u,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,o)=>(p(),n("div",t,c))}});export{d as default,m as excerpt,j as frontmatter};
