import{d as a,c as n,b as l,o as p}from"./vue.38f8d396.js";const t={class:"markdown-body"},e=l(`<h2>\u7EC4\u4EF6\u4E4B\u95F4\u590D\u6742\u6570\u636E\u4F20\u9012</h2><p>\u7236\u7EC4\u4EF6\u7684\u6570\u636E</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement, state } <span class="hljs-keyword">from</span> <span class="hljs-string">&#39;quarkc&#39;</span>;
...
</code></pre><p align="left"> Live Demo: <a href="https://stackblitz.com/edit/vite-quarkc-internalprop?file=src%2Findex.tsx&amp;file=src%2Fchild.tsx"><img src="https://developer.stackblitz.com/img/open_in_stackblitz.svg" alt=""></a></p>`,6),c=[e],j={},u="",m=a({__name:"innerprop.zh-CN",setup(r,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(h,o)=>(p(),n("div",t,c))}});export{m as default,u as excerpt,j as frontmatter};
