import{d as a,c as n,b as l,o as t}from"./vue.724a6942.js";const p={class:"markdown-body"},e=l(`<h2>Watchers and Computed</h2><h3>Watchers</h3><p>Watching changes of reactive states or properties by <code class="">@watch</code> directive.</p><pre><code class="language-tsx"><span class="hljs-meta">@customElement</span>({ <span class="hljs-attr">tag</span>: <span class="hljs-string">&quot;quark-count&quot;</span> })
