import{d as a,c as n,b as l,o as t}from"./vue.ceba7882.js";const p={class:"markdown-body"},c=l(`<h2>\u63D2\u69FD</h2><h3>\u9ED8\u8BA4\u63D2\u69FD</h3><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
</code></pre><pre><code class="language-html"><span class="hljs-tag">&lt;<span class="hljs-name">quark-count</span>&gt;</span><span class="hljs-tag">&lt;<span class="hljs-name">span</span> <span class="hljs-attr">slot</span>=<span class="hljs-string">&quot;abc&quot;</span>&gt;</span>\u6211\u662F\u5177\u540D\u63D2\u69FD<span class="hljs-tag">&lt;/<span class="hljs-name">span</span>&gt;</span><span class="hljs-tag">&lt;/<span class="hljs-name">quark-count</span>&gt;</span>
...
</code></pre><p>\u66F4\u591A <code class="">slot</code> \u63D2\u69FD\u4F7F\u7528\u53EF\u53C2\u8003<a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_templates_and_slots">Slot</a></p>`,12),e=[c],j={},m="",g=a({__name:"slot.zh-CN",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(u,h)=>(t(),n("div",p,e))}});export{g as default,m as excerpt,j as frontmatter};
