import{d as a,c as n,b as t,o as e}from"./vue.02c93f74.js";const l={class:"markdown-body"},p=t(`<h2>Reactivity</h2><p>Reactive state.</p><h3>Internal State</h3><p><strong>Reactive data</strong> within the component.</p><p>Use the <code class="">@state</code> decorator to add reactivity to your component\u2019s internal state.</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement, state} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
</code></pre><p><a href="https://github.com/hellof2e/quark-design/blob/main/packages/quarkd/src/cascadepicker/index.tsx">For more usage techniques, refer to this example</a></p>`,29),c=[p],u={},m="",j=a({__name:"reactivity.en-US",setup(o,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(r,h)=>(e(),n("div",l,c))}});export{j as default,m as excerpt,u as frontmatter};
