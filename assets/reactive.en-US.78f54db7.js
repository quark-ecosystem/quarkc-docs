import{d as a,c as n,b as t,o as e}from"./vue.63351e00.js";const l={class:"markdown-body"},p=t(`<h2>Reactive</h2><p>Reactive state.</p><h3>Internal State</h3><p><strong>Reactive data</strong> within the component.</p><p>Use the <code class="">@state</code> decorator to add reactivity to your component\u2019s internal state.</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement, state} <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
