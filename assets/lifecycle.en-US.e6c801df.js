import{d as n,c as a,b as e,o as t}from"./vue.9d8aef45.js";const l={class:"markdown-body"},c=e(`<h2>Lifecycle</h2><p><code class="">Quarkc</code> provides lifecycle methods to help you manage the component.</p><table><thead><tr><th>Method Name</th><th>Trigger Timing</th></tr></thead><tbody><tr><td><code class="">componentDidMount</code></td><td>Invoked after <code class="">connectedCallback</code> triggered and the component finishes first rendering (mounted, inserted into th e <code class="">dom</code> tree). You can access the <code class="">dom</code> at this time.</td></tr><tr><td><code class="">shouldComponentUpdate</code></td><td>Invoked after <code class="">attributeChangedCallback</code> triggered and before the component rendering. You can decide whether to update the component or not by letting this method return <code class="">true</code> or <code class="">false</code>. <em>\uFF08\u26A0\uFE0F deprecated from v2.0.0 and is not recommended\uFF0Cit will be removed in next major version\uFF09</em></td></tr><tr><td><code class="">componentDidUpdate</code></td><td>Invoked everytime <code class="">attributeChangedCallback</code> was triggered and the component finishes rendering. You can access the <code class="">dom</code> at this time. <em>\uFF08\u26A0\uFE0F from v2.0.0, when <code class="">componentDidMount</code> is also defined, it will not be invoked at mount phase\uFF09</em></td></tr><tr><td><code class="">componentUpdated</code> <em>\uFF08new\u2B50\uFE0F v2.0.0\uFF09</em></td><td>Distinct from <code class="">componentDidUpdate</code>, it will be invoked after all of the component\u2019s props and states\u2019 updates finished. You can access the <code class="">dom</code> at this time.</td></tr><tr><td><code class="">componentWillUnmount</code></td><td>Invoked after <code class="">disconnectedCallback</code> triggered and before the <code class="">dom</code> removed. You can clean up the side effects here.</td></tr></tbody></table><p>Among them, <code class="">connectedCallback</code>\u3001<code class="">attributeChangedCallback</code>\u3001<code class="">disconnectedCallback</code> are all native <code class="">Web Components</code>\u2019s lifecycle method\uFF0Cyou can refer to <a href="https://developer.mozilla.org/en-US/docs/Web/Web_Components/Using_custom_elements#using_the_lifecycle_callbacks">this article</a> for more details.</p><h3>example</h3><pre><code class="language-tsx">
...
</code></pre>`,6),o=[c],h={},m="",u=n({__name:"lifecycle.en-US",setup(p,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(d,r)=>(t(),a("div",l,o))}});export{u as default,m as excerpt,h as frontmatter};
