import{d as a,c as n,b as l,o as p}from"./vue.38f8d396.js";const t={class:"markdown-body"},e=l(`<h2>Rendering</h2><p>Add a <code class="">render</code> method to your custom element.</p><pre><code class="language-tsx"><span class="hljs-keyword">import</span> { QuarkElement, customElement } <span class="hljs-keyword">from</span> <span class="hljs-string">&quot;quarkc&quot;</span>
...
</code></pre>`,10),c=[e],u={},d="",m=a({__name:"rendering.en-US",setup(r,{expose:s}){return s({frontmatter:{},excerpt:void 0}),(o,h)=>(p(),n("div",t,c))}});export{m as default,d as excerpt,u as frontmatter};
